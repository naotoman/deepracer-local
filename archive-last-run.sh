...
aws s3 cp data/minio/bucket/custom_files/reward.py s3://$S3_BUCKET/$S3_PREFIX/reward/
aws s3 cp data/minio/bucket/current/ip/hyperparameters.json s3://$S3_BUCKET/$S3_PREFIX/hyperparameters/
